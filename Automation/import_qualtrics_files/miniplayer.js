(function(g){var window=this;'use strict';var lab=function(a){g.V.call(this,{F:"div",K:"ytp-miniplayer-ui"});this.Bf=!1;this.player=a;this.S(a,"minimized",this.nh);this.S(a,"onStateChange",this.SL)},mab=function(a){g.vP.call(this,a);
this.u=new g.QE(this);this.j=new lab(this.player);this.j.hide();g.OO(this.player,this.j.element,4);a.Jf()&&(this.load(),g.po(a.getRootNode(),"ytp-player-minimized",!0));this.player.N("web_rounded_containers")&&g.po(a.getRootNode(),"ytp-rounded-miniplayer",!0)};
g.v(lab,g.V);g.k=lab.prototype;
g.k.fJ=function(){this.tooltip=new g.vT(this.player,this);g.M(this,this.tooltip);g.OO(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.Ic=new g.oQ(this.player);g.M(this,this.Ic);this.Ci=new g.V({F:"div",K:"ytp-miniplayer-scrim"});g.M(this,this.Ci);this.Ci.Ca(this.element);this.S(this.Ci.element,"click",this.qE);var a=new g.V({F:"button",Ga:["ytp-miniplayer-close-button","ytp-button"],X:{"aria-label":"Close"},W:[g.kM()]});g.M(this,a);a.Ca(this.Ci.element);this.S(a.element,"click",this.Kn);
a=new g.v2(this.player,this);g.M(this,a);a.Ca(this.Ci.element);this.Ls=new g.V({F:"div",K:"ytp-miniplayer-controls"});g.M(this,this.Ls);this.Ls.Ca(this.Ci.element);this.S(this.Ls.element,"click",this.qE);var b=new g.V({F:"div",K:"ytp-miniplayer-button-container"});g.M(this,b);b.Ca(this.Ls.element);a=new g.V({F:"div",K:"ytp-miniplayer-play-button-container"});g.M(this,a);a.Ca(this.Ls.element);var c=new g.V({F:"div",K:"ytp-miniplayer-button-container"});g.M(this,c);c.Ca(this.Ls.element);this.LS=new g.RR(this.player,
this,!1);g.M(this,this.LS);this.LS.Ca(b.element);b=new g.PR(this.player,this);g.M(this,b);b.Ca(a.element);this.nextButton=new g.RR(this.player,this,!0);g.M(this,this.nextButton);this.nextButton.Ca(c.element);this.Fi=new g.iT(this.player,this);g.M(this,this.Fi);this.Fi.Ca(this.Ci.element);this.Cc=new g.cS(this.player,this);g.M(this,this.Cc);g.OO(this.player,this.Cc.element,4);this.fE=new g.V({F:"div",K:"ytp-miniplayer-buttons"});g.M(this,this.fE);g.OO(this.player,this.fE.element,4);a=new g.V({F:"button",
Ga:["ytp-miniplayer-close-button","ytp-button"],X:{"aria-label":"Close"},W:[g.kM()]});g.M(this,a);a.Ca(this.fE.element);this.S(a.element,"click",this.Kn);a=new g.V({F:"button",Ga:["ytp-miniplayer-replay-button","ytp-button"],X:{"aria-label":"Close"},W:[g.rM()]});g.M(this,a);a.Ca(this.fE.element);this.S(a.element,"click",this.T1);this.S(this.player,"presentingplayerstatechange",this.Vc);this.S(this.player,"appresize",this.Bb);this.S(this.player,"fullscreentoggled",this.Bb);this.Bb()};
...
g.k.T1=function(){this.player.playVideo()};
...
g.k.Dp=function(){};
g.k.iC=function(){};
g.k.mq=function(){};g.v(mab,g.vP);g.k=mab.prototype;g.k.onVideoDataChange=function(){if(this.player.N("web_rounded_containers")&&this.player.getVideoData()){var a=16/9;a=this.player.getVideoAspectRatio()>a+.1;g.po(this.player.getRootNode(),"ytp-rounded-miniplayer-extra-wide-video",a)}};
...
g.k.unload=function(){this.player.showControls();this.j.hide()};g.uP("miniplayer",mab);})(_yt_player);
